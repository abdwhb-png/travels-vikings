            ...
            <div class="col-6 mx-auto bg-dark py-4 rounded">
                ...
                >
                    ...
                    <p v-else class="mb-0 small opacity-70">
                        <a class="btn btn-primary" href="/admin/system/users">Back to system users list</a>
                    </p>
                    <button
                        type="button"
                        class="btn-close"
...
export default {
    ...
    methods: {
        async submit() {
            await this.mystore.updateItem("/admin/update/system-user/"+this.id, this.item)
            this.submited=true
            this.spinning=true
            setTimeout(() => {
            this.spinning=false
    ...
    created: function () {
        this.mystore.getItem("/admin/get/item/system-user/" + this.id);
    },
};
</script>
